    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      >
        ...
        >
          ...
          {user ? <UserMenu /> : <GoogleSignInButton onError={setError} />}
        </nav>
      </header>
      ...
      {(result || loading) && (
        <div
          style={{ maxWidth: 640, margin: "24px auto 40px", padding: "0 20px" }}
        >
          <div
            style={{
              display: "flex",
      ...
      {result && !loading && (
        <div
          style={{ maxWidth: 1200, margin: "0 auto", padding: "0 20px 60px" }}
        >
          <div
            style={{
              marginBottom: 24,
          ...
          >
            <div>
              ...
              >
                Top picks for{" "}
                <span style={{ color: "var(--accent)" }}>{result.query}</span>
              </h2>
          ...
          {result.totalProducts === 0 ? (
            <div style={{ textAlign: "center", padding: "80px 20px" }}>
              ...
              <div style={{ color: "var(--text-muted)", fontSize: 14 }}>
                Try a more specific query like "best phones under 30k" or "best
                TWS under 2000"
              </div>
            </div>
          ) : (
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse 700px 500px at 50% 50%, rgba(5,6,7,0.88) 0%, rgba(5,6,7,0.6) 45%, rgba(5,6,7,0.35) 100%)",
        }}
      />
      ...
      >
        ...
        >
          Deal<span style={{ color: "#fff" }}>finder</span>
        </div>
          ...
          {steps.map((_, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: 3,
                background:
                  i === stepIndex ? "#4ade80" : "rgba(255,255,255,0.15)",
